      ...
      <div>
        ...
        >
          <div className="navbar">
            ...
            {this.state.user ? (
              <Link to="/Wishlist">
                <button className="bt-login">WISHLIST</button>
              </Link>
            ) : null}
            {this.state.user ? (
              <button className="bt-login" onClick={this.logout}>
                LOGOUT
              </button>
            ) : (
              <Link to="/Login">
                <button className="bt-login">LOGIN / SIGNUP</button>
              </Link>
            )}
            <Link to="Contact">
              <button className="bt-login">CONTACT US</button>
            </Link>
          </div>
