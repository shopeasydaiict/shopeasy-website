              ...
              <div className="top">
                <div className="left">
                  <a href="/"> {/*homepage link*/}
                    ...
                    <img alt="ShopEasy" src={require("./resources/shopeasy_logo_xs.png")}
              ...
              <div className="list">
                  {this.state.wishlistData.map(data => (
                        ...
                        <a href={data.product_url}>
                          <img src={data.image_url} alt="Image Unavailable" className="product-image" />
                        ...
                        <button>
                          <a rel="stylesheet" href="#">
                            <img src={require("./resources/cross.png")} alt="Remove item" className="close" onClick={e => this.removeFromWishlist(e,data.id)}/>
                          </a>
                        </button>
                      </div>
                ))}
